...
def calcular_todos_hq():
    ...
    altura_mm = float(input("Altura da placa (mm): "))
    largura_mm = float(input("Largura da placa (mm): "))
    comprimento_mm = float(input("Comprimento da placa (mm): "))
    ...
    # Comprimento característico para horizontal
    A = largura * comprimento
    P = 2 * (largura + comprimento)
    L_horizontal = A / P

    # Comprimento característico para vertical
    L_vertical = altura
